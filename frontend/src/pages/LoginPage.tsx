    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-border bg-surface hover:bg-surface-light transition-colors text-text-primary font-medium cursor-pointer"
        >
        ...
        <form onSubmit={handleEmailAuth} className="space-y-3">
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-border bg-surface text-text-primary placeholder:text-text-secondary/50 focus:outline-none focus:border-primary text-sm"
            />
          </div>
          <div className="relative">
